...
ALTER TYPE moderation_action_type ADD VALUE 'adminUsers.banFromBoards' AFTER 'adminUsers.unban';
ALTER TYPE moderation_action_type ADD VALUE 'adminUsers.unbanFromBoards' AFTER 'adminUsers.banFromBoards';
