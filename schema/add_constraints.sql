...
ALTER TABLE userviews ADD CONSTRAINT userviews_thread_id_fk FOREIGN KEY (thread_id) REFERENCES threads (id);
ALTER TABLE userviews ADD CONSTRAINT userviews_user_id_fk FOREIGN KEY (user_id) REFERENCES users (id);
